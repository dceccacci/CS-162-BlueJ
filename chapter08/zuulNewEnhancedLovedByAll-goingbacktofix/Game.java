...
public class Game 
{
    ...
    private void createRooms()
    {
        ...
        //Item bell, flashlight, bucket, anvil;
        ...
        // add items to rooms.
        lab.setItem("bucket", 8);
        cellar.setItem("anvil", 233);
        pub.setItem("bucket", 8);
        theater.setItem("bell", 80);
    ...
    private void printLocationInfo()
    {
        ...
        /**if(currentRoom.getItemArray() != null)
        {
            ArrayList <Item> roomItems = currentRoom.getItemArray();
     ...
     * are resting, and Refills stamina counter.
     */
    private void rest()
    {
